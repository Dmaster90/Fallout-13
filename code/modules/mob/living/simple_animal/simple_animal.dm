/mob/living/simple_animal
	...
	var/stop_automated_movement = 1 //Use this to temporarely stop random movement or to if you write special movement code for animals.
	var/wander = 0	// Does the mob wander around when idle?
